...
// File @openzeppelin/contracts/crowdsale/emission/AllowanceCrowdsale.sol@v2.5.1
...
// File @openzeppelin/contracts/access/roles/CapperRole.sol@v2.5.1
...
// File contracts/RewardsPresale.sol
...
contract RewardsPresale is Crowdsale, AllowanceCrowdsale, CappedCrowdsale, TimedCrowdsale, CapperRole {
  ...
  constructor(
    uint256 initialRate,     // rate, in TKNbits
    address payable wallet,  // wallet to send Ether
    IERC20 token,            // the token
    address tokenWallet,     // token wallet
  ...
  function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
    super._preValidatePurchase(beneficiary, weiAmount);
    // solhint-disable-next-line max-line-length
    require(_contributions[beneficiary].add(weiAmount) <= getCap(beneficiary), "Rewards Presale: beneficiary's cap exceeded");
  }
